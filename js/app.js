...
if (iconMenu != null) {
	...
	let menuAuth = document.querySelector(".menu-auth__body");
	let menuAuthList = document.querySelector(".menu-auth__list");
	iconMenu.addEventListener("click", function (e) {
		if (unlock) {
			...
			menuAuthList.classList.toggle('on');
		}
	});
};
function menu_close() {
	...
	menuAuth.classList.remove("_active");
}
//=================
//BodyLock
